...
▶ Gets a list of new informational alerts, closes them, and adds a comment to the closed alerts: Get-SCOMAlert -ResolutionState 0 -Severity 0 | Resolve-SCOMAlert -Comment 'Chuck Norris closed these informational alerts with fists of fury and the command shell.'
▶ Gets a list of new error alerts, closes the alerts, and adds a comment to the closed alerts: Get-SCOMAlert -ResolutionState 0 -Severity 2 | Resolve-SCOMAlert -Comment 'Automated close out of alerts.'
